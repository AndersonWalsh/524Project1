...
class OutputProcessor:
    ...
    def process_investigator_pair_first_occurrence(self, chapter: int, sentence: int) -> str:

        """ first occurrence of the investigator or pair """

        data = self.interface.investigator_pair_first_occurrence(chapter, sentence)
    ...
    def process_first_mention_of_perpetrator(self, chapter: int, sentence: int) -> str:
        
        """ for the first mention of the perpetrator """
        
        data = self.interface.first_mention_of_perpetrator(chapter, sentence)
    ...
    def process_detective_perpetrator_cooccurrence(self, chapter: int, sentence: int) -> str:
