response_templates = {
    ...
    "investigator_pair_first_occurrence": "The investigator {name} (or pair) first appears in Chapter {chapter} and Sentence {sentence}.",
    ...
    "first_mention_of_perpetrator": "The perpetrator, whose name is {name}, is first mentioned in Chapter {chapter}, Sentence {sentence}.",
